...
--
-- Host: localhost    Database: devlogs
-- ------------------------------------------------------
...
CREATE TABLE `goals` (
  ...
  KEY `goals_topic_id_foreign` (`topic_id`),
  CONSTRAINT `goals_topic_id_foreign` FOREIGN KEY (`topic_id`) REFERENCES `topics` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `logs` (
  ...
  KEY `logs_topic_id_foreign` (`topic_id`),
  CONSTRAINT `logs_topic_id_foreign` FOREIGN KEY (`topic_id`) REFERENCES `topics` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `resources` (
  ...
  `type` enum('video','article','course','docs') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'article',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `resources_user_id_foreign` (`user_id`),
  KEY `resources_topic_id_foreign` (`topic_id`),
  CONSTRAINT `resources_topic_id_foreign` FOREIGN KEY (`topic_id`) REFERENCES `topics` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2026-05-15 18:53:59
