<x-app-layout>
    ...
    <div class="page-container">
        ...
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:1.5rem;">
            ...
            <h1 style="font-family:'Space Grotesk',sans-serif; font-size:1.2rem; font-weight:700; color:#f0ece8;">Edit
                Resource</h1>
        </div>
        ...
        <div class="dash-card" x-data="{
            ...
            typeOpen: false,
            topicId: '{{ old('topic_id', $resource->topic_id ?? '') }}',
            topicOpen: false,
        }">
            ...
            <form method="POST" action="{{ route('resources.update', $resource) }}">
                ...
                <div class="form-group">
                    ...
                    <input id="title" name="title" type="text"
                        class="auth-input @error('title') input-error @enderror"
                        value="{{ old('title', $resource->title) }}" required autofocus>
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input id="url" name="url" type="url"
                        class="auth-input @error('url') input-error @enderror" value="{{ old('url', $resource->url) }}"
                        required>
                    @error('url')
                        <p style="font-size:12px; color:#f87171; margin-top:4px;">{{ $message }}</p>
                    @enderror
